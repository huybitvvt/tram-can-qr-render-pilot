...
$installerPath = Join-Path $installerDir "TramCanQR-Setup-0.2.0-rc33.exe"
if ($iscc) {
...
$handoffDir = Join-Path $projectRoot "dist\handoff-0.2.0-rc33"
...
if (Test-Path -LiteralPath $installerPath) {
    ...
    $portableArchive = Join-Path $handoffDir "TramCanQR-portable-0.2.0-rc33.zip"
