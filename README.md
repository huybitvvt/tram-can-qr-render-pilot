...
>    Bản `0.2.0-rc18`: [tải file có số phiên bản](https://github.com/huybitvvt/tram-can-qr-render-pilot/releases/download/v0.2.0-rc18/TramCanQR-Setup-0.2.0-rc18.exe).
...
- Bộ cài bản hiện tại: `dist\installer\TramCanQR-Setup-0.2.0-rc18.exe` khi máy build có Inno Setup 6.
