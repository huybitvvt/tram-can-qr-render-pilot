...
Phiên bản: `0.2.0-rc21` — bản chạy thử nghiệm thu tại xưởng.

## 1. Cài đặt

1. Đóng bản đang chạy, sau đó chạy file `TramCanQR-Setup-0.2.0-rc21.exe`
...
Nếu màn hình báo chưa lưu được ảnh, giữ nguyên ảnh và bấm lại nút để thử lại.
