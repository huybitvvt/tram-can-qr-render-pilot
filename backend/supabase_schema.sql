...
create table if not exists public.measurements (
  ...
  weight numeric(14,3) check (weight >= 0),
  tare_weight numeric(14,3) check (tare_weight >= 0 and tare_weight <= weight),
...
create table if not exists public.ca_can (
  ...
  dot_can integer not null,
  moc_so_luong integer not null,
